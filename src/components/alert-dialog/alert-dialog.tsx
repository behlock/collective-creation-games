  ...
  switch (page) {
    case 1:
      return (
        <>
          ...
          <p>
            Both these claims have been put into the test during street interventions, festivals, workshop sessions with
            groups, collectives, alternative education endeavors, and grassroots organizations. A methodological
            ...
            understanding/embracing the role of the facilitator and the importance of the critical reflection, observing
            the individual/group dynamics and tending the creative process.
          </p>
          <p>
    ...
    case 2:
      return (
        <>
          <p>
            The <b>3D mindmap</b> is an invitation to explore, to build relationships and approach things from different
            perspectives.
          </p>
          <p>How to navigate it:</p>
          <p>
            By clicking on a central <i>node</i>, you reveal its <i>leaves</i>. By clicking on it again you collapse
            them.
          </p>
    ...
    case 3:
      ...
      ;<>
        <p>
          Our method has many applications which might benefit you and your organization. If its related to individuals
          and collectives, learning, thinking, designing, trying, creating then we can probably work together.
        </p>
        <p>
